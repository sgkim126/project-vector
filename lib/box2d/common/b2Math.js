...
box2d.Math.b2MulM33A3 = function(A, v, out) {
    out[0] = v[0] * A.col1.x + v[1] * A.col2.x + v[2] * A.col3.x;
    out[1] = v[0] * A.col1.y + v[1] * A.col2.y + v[2] * A.col3.y;
    out[2] = v[0] * A.col1.z + v[1] * A.col2.z + v[2] * A.col3.z;
}
