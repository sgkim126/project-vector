...
box2d.Vec2.prototype.Default = function() {
  this.SetZero();
};
...
/**
 ...
 @return {!box2d.Vec2}
 */
box2d.Vec2.prototype.DivV = function(v) {
  this.x /= v.x;
  this.y /= v.y;
};
...
/**
 ...
 @return {!box2d.Vec2}
 */
box2d.Vec2.prototype.MulV = function(v) {
  this.x *= v.x;
  this.y *= v.y;
};

box2d.Vec2.prototype.Mul = function(v) {
  this.x *= v;
  this.y *= v;
};

box2d.Vec2.prototype.Div = function(v) {
  v = 1 / v;
  this.x *= v;
  this.y *= v;
};
...
box2d.Vec2.prototype.AddV = function(v) {
  this.x += v.x;
  this.y += v.y;
};

box2d.Vec2.prototype.Sub = function(v) {
  this.x -= v;
  this.y -= v;
};

box2d.Vec2.prototype.SubV = function(v) {
  this.x -= v.x;
  this.y -= v.y;
};
